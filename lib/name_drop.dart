...
import 'package:explore_blur_effect/shader_builder.dart';

void main() {
  runApp(const App(home: NameDropIOS17()));
}
...
@immutable
class NameDropIOS17 extends StatefulWidget {
  const NameDropIOS17({super.key});

  @override
  State<NameDropIOS17> createState() => _NameDropIOS17State();
}

class _NameDropIOS17State extends State<NameDropIOS17> {
    ...
    Timer(duration, () {
      setState(() {
        data.insert(
            ...
            Message(
                text: "New Message",
                owner: Platform.isIOS
                    ? MessageOwner.myself
                    : MessageOwner.myself)); // Insert your new message object
        isSending = false;
      });
    });
  }
  ...
  Widget build(BuildContext context) {
    return Banner(
      ...
      child: MinuteChangeShaderEffect(
        child: Theme(
          data: ThemeData(
          ...
          child: Stack(
            children: [
              ...
              Scaffold(
                ...
                //   child: isSending ? CircularProgressIndicator() : Icon(Icons.send),
                // ),
              ),
            ],
          ),
